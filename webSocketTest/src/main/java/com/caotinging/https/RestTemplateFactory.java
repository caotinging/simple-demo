...
public class RestTemplateFactory {
	...
	@Value("${httpconn.maxTotalTmp}")
	public void setMaxTotal(Integer maxTotalTmp) {
		maxTotal = maxTotalTmp;
	}
	
	private static Integer maxPerRoute;
	
	@Value("${httpconn.maxPerRouteTmp}")
	public void setMaxPerRoute(Integer maxPerRouteTmp) {
		maxPerRoute = maxPerRouteTmp;
	}
